<template>
  <el-drawer title="TimePicker 配置" size="50%" :visible.sync="visible" append-to-body :before-close="beforeClose">
    <el-form ref="form" :model="formData" :rules="rules" label-position="top" size="small" label-suffix="：">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="是否为时间范围选择" prop="is-range">
            <el-switch v-model="formData['is-range']" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="20" v-if="formData['is-range']">
        <el-col :span="12">
          <el-form-item label="范围选择时开始日期的占位内容" prop="start-placeholder">
            <el-input v-model="formData['start-placeholder']"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="范围选择时开始日期的占位内容" prop="end-placeholder">
            <el-input v-model="formData['end-placeholder']"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="20">
